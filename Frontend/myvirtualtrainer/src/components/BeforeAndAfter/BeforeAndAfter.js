...
const BeforeAndAfter = () => {
  ...
  const hanfleGenerateClick = () => {
    if (beforeImg !== photo && afterImg !== photo) {
      ...
      var imageBeforeDraw = new Image(
        imgBeforeForCanvas.width,
        imgBeforeForCanvas.height
      );
